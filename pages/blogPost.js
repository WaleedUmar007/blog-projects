...
export default function Blogpost() {
  return (
    <div className={styles.container}>
      ...
      <h1 >
          11 Companies that hire for Remote
        </h1>
        <h1>
      ...
      <section className='flex mt-3 w-full space-x-4'>
        <div className='w-full lg:w-2/3 px-4 py-4 leading-6'>
            <Image className='rounded-md' src={image} alt="Sunset in the mountains" width={866} height={473} />
        ...
        <div className={"font-sans font-normal text-[24px] text-justify leading-8 text-[#37404E]"}>
          ...
          Kitchen is a daily food magazine on the Web celebrating life in the kitchen through home cooking and kitchen intelligence.
          </p>
        </div>
        ...
        <div className={"font-montserrat font-semibold text-[24px] text-justify leading-8 text-[#1F2938] mt-4"}>
          <p>Lorem ipsum dolor sit amet cons</p>
        </div>

        <div className={"font-sans font-normal text-[18px] text-justify text-[#1F2938] mt-2"}>
          <p>
          Tortor, lobortis semper viverra ac, molestie tortor laoreet amet euismod et diam quis aliquam consequat porttitor integer a nisl,
          in faucibm eros est amet turpis nunc in turpis massa et eget facilisis ante molestie penatibus dolor volutpat, porta pellentesque
        ...
        <div className=''>
            <Image className='rounded-md' src={image} alt="Sunset in the mountains" width={410} height={410} />
        </div>
        ...
        <div className={"font-sans font-normal  text-[18px] text-justify leading-6 text-[#37404E] mt-2"}>
          <p>
          Sit quis semper sit sapien. Massa bibendum scelerisque metus phasellus semper sed. Enim, lacus faucibus aliquam id vitae a et pellentesque amet.
          Felis quam lacinia elementum arcu. Tempor ullamcorper donec sit arcu varius diam luctus ultrices
          </p>
        </div>

        <div className='bg-[#F5F5F5] px-12 py-12 my-4 mx-12 rounded-tr-3xl rounded-bl-3xl justify-center items-center relative'>
        <div className='absolute top-0 left-0 px-4 py-4'>
          ...
          in vehicula a, id placerat consequat mauris non adipiscing in sed et dui tristique at amet, nunc
          </p>
        ...
        <div className={"font-sans font-normal text-[18px] text-justify leading-6 text-[#37404E] mt-2"}>
          <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet id enim, libero sit. Est donec lobortis cursus amet,
          cras elementum libero convallis feugiat.
          Nucilisi tincidunt a arcu, sem donec sed sed. Tincidunt morbi scelerisque lectus non. At leo mauris, vel augue. Facilisi diam
          </p>
        </div>
        ...
        <div className='flex space-x-2'>
          <div>
            <Image className='rounded-full' src={image} alt="Sunset in the mountains" width={64} height={64} />
          </div>
          <div>
        ...
        <div className='font-sans font-normal text-[18px] text-[#37404E] leading-6'>
          <p>Hi there, I am a veteran food blogger sharing my daily all kinds of healthy and fresh recipes. I find inspiration in nature, on the streets and almost everywhere.
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet id enim, libero sit. Est donec lobortis cursus amet</p>
        </div>
        </div>
